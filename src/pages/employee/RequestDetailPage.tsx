import { ArrowLeft, Boxes, CalendarClock, ClipboardList, Package, Printer } from 'lucide-react'
...
import { useCancelRequest, useRequest, useUpdateRequest } from '@/hooks/useRequests'
      ...
      <section className="request-screen-content rounded-xl border border-border bg-surface-raised p-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-text-secondary">Project, status, and request timing for this material request.</p>
          </div>
        ...
        <dl className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="rounded-lg border border-border bg-background p-3">
            <dt className="text-sm text-text-secondary">Request ID</dt>
            <dd className="mt-1 truncate text-sm font-medium tabular-nums text-text-primary">{request.id}</dd>
          </div>
        </dl>
      ...
      <section className="request-screen-content rounded-xl border border-border bg-surface-raised p-5">
        <div className="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="text-sm text-text-secondary">Products and quantities submitted for this request.</p>
          </div>
